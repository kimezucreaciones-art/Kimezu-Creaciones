        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 md:mb-16 text-center md:text-left">
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 justify-center md:justify-start items-center">
              <a href="#" className="hover:text-kimezu-primary transition-colors"><Instagram size={20} /></a>
              <a href="#" className="hover:text-kimezu-primary transition-colors"><Facebook size={20} /></a>
              <a href="#" className="hover:text-kimezu-primary transition-colors"><TikTokIcon size={20} /></a>
              <a href="#" className="hover:text-kimezu-primary transition-colors"><XIcon size={18} /></a>
            </div>
          </div>
