...
import { Plus, Edit, Trash2, X, Save, Search, Upload, Image as ImageIcon, Layout, Box, Gift, Check } from 'lucide-react';
...
export const AdminDashboard: React.FC = () => {
  ...
  const handleAssetUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0] && editingAssetKey) {
      ...
      updateAsset(editingAssetKey, imageUrl);
        ...
        {activeTab === 'assets' && (
          <div className="animate-fade-in grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             {siteAssets.map(asset => (
               <div key={asset.key} className="bg-white p-4 border border-kimezu-card shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   ...
                   <div>
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-2">
                         ...
                         <div 
                           className="aspect-square border-2 border-dashed border-kimezu-card bg-stone-50 hover:bg-white hover:border-kimezu-primary transition-colors flex flex-col items-center justify-center cursor-pointer"
